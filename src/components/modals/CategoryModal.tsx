...
const CategoryModal = ({ isOpen, setIsOpen, editData, setEditData, refetch }: AppSliderModalProps) => {
    ...
    // Submit handler
    const onFinish = async (values: { contentTitle: string }) => {
        ...
        try {
            ...
            if (editData) {
                ...
                res = await updateCategory({ id: editData._id, body: formData }).unwrap();
            } else {
                // Create new category
